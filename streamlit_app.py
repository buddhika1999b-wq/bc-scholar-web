...
# මුල් පිටුවේ පින්තූරය (හිමිනම සහ ශිෂ්‍යයා)
img_home_url = "https://github.com/B Buddika/BC-Scholar-Assets/raw/main/image_0.png"
# ලියාපදිංචි පෝරමයට ඉහළින් පින්තූරය (දොරටුව සහ නෙළුම් පොකුණ)
img_reg_url = "https://github.com/B Buddika/BC-Scholar-Assets/raw/main/image_2.png"
# සිතියමට ඉහළින් පින්තූරය (රන්වන් ධර්මචක්‍රය සහිත සිතියම)
img_map_url = "https://github.com/B Buddika/BC-Scholar-Assets/raw/main/image_4.png"
# පන්ති ටැබ් එකට ඉහළින් පින්තූරය (මණ්ඩපයේ Laptop එකක්)
img_class_url = "https://github.com/B Buddika/BC-Scholar-Assets/raw/main/image_6.png"
# පසුබිම් පින්තූරය (බුදුරජාණන් වහන්සේගේ රැස් වළල්ල සහිත)
img_back_url = "https://github.com/B Buddika/BC-Scholar-Assets/raw/main/image_10.png"
...
# --- 3. WhatsApp Group Links (ඔයා දුන්න ලින්ක්ස්) ---
WHATSAPP_GROUPS = {
...
# --- 6. CSS (Styles & Design) ---
# මෙතන background image ලින්ක් එක අපි හදාගත්ත එකට වෙනස් කළා
st.markdown(f"""
    <style>
    @import url('https://fonts.googleapis.com/css2?family=Kotta+One&family=Yaldevi:wght@300;500;700&display=swap');
    
    /* මුළු App එකේම Background එක (AI Generated Image එක සමඟ) */
    .stApp {{
...
with menu[0]:
    ...
    <b>ගුරු මෙහෙයවීම :මචං, නියමයි! ඔන්න අපි කලින් Generate කරගත්ත, Copyright ප්‍රශ්න නැති, ලස්සන AI Images 5 ම (Background එකත් ඇතුළුව) ඔයා දුන්න Code එකට මම සෙට් කළා.

දැන් App එකේ පෙනුම සම්පූර්ණයෙන්ම Professional සහ අධ්‍යාත්මික ගතියකින් යුක්තයි.

මෙන්න පින්තූර ටික සෙට් කරපු අලුත්ම Code එක:
...
# --- 1. පින්තූර ලින්ක්ස් (AI Generated) ---
# මුල් පිටුවේ පින්තූරය (හිමිනම සහ ශිෂ්‍යයා)
img_home_url = "[https://raw.githubusercontent.com/B-Buddika/BC-Scholar-Assets/main/image_0.png](https://raw.githubusercontent.com/B-Buddika/BC-Scholar-Assets/main/image_0.png)"
# ලියාපදිංචි පෝරමයට ඉහළින් පින්තූරය (දොරටුව සහ නෙළුම් පොකුණ)
img_reg_url = "[https://raw.githubusercontent.com/B-Buddika/BC-Scholar-Assets/main/image_2.png](https://raw.githubusercontent.com/B-Buddika/BC-Scholar-Assets/main/image_2.png)"
# සිතියමට ඉහළින් පින්තූරය (රන්වන් ධර්මචක්‍රය සහිත සිතියම)
img_map_url = "[https://raw.githubusercontent.com/B-Buddika/BC-Scholar-Assets/main/image_4.png](https://raw.githubusercontent.com/B-Buddika/BC-Scholar-Assets/main/image_4.png)"
# පන්ති ටැබ් එකට ඉහළින් පින්තූරය (මණ්ඩපයේ Laptop එකක්)
img_class_url = "[https://raw.githubusercontent.com/B-Buddika/BC-Scholar-Assets/main/image_6.png](https://raw.githubusercontent.com/B-Buddika/BC-Scholar-Assets/main/image_6.png)"
# පසුබිම් පින්තූරය (බුදුරජාණන් වහන්සේගේ රැස් වළල්ල සහිත)
img_back_url = "[https://raw.githubusercontent.com/B-Buddika/BC-Scholar-Assets/main/image_10.png](https://raw.githubusercontent.com/B-Buddika/BC-Scholar-Assets/main/image_10.png)"

# --- 2. පිටුවේ මූලික සැකසුම් ---
icon_url = "[https://media.istockphoto.com/id/1455197782/vector/red-dharmachakra-wheel-of-dhamma-on-lotus-petals-sign-on-yellow-background-vector-design.jpg?s=612x612&w=0&k=20&c=eywlzFMds0xQEgg9FKSnIMcjDIgq4bsV5VysnZmc2d0=](https://media.istockphoto.com/id/1455197782/vector/red-dharmachakra-wheel-of-dhamma-on-lotus-petals-sign-on-yellow-background-vector-design.jpg?s=612x612&w=0&k=20&c=eywlzFMds0xQEgg9FKSnIMcjDIgq4bsV5VysnZmc2d0=)"
st.set_page_config(page_title="BC-Scholar", page_icon=icon_url, layout="centered")

# --- 3. WhatsApp Group Links ---
WHATSAPP_GROUPS = {
    "2026 A/L": "[https://chat.whatsapp.com/ElrGd68bvXDGEYw5XBEb1f](https://chat.whatsapp.com/ElrGd68bvXDGEYw5XBEb1f)",
    "2027 A/L": "[https://chat.whatsapp.com/ElrGd68bvXDGEYw5XBEb1f](https://chat.whatsapp.com/ElrGd68bvXDGEYw5XBEb1f)",
    "2028 A/L": "[https://chat.whatsapp.com/JZdWvJT6gX6J0uqUFNvTuK](https://chat.whatsapp.com/JZdWvJT6gX6J0uqUFNvTuK)"
}
...
st.markdown(f"""
    <style>
    @import url('[https://fonts.googleapis.com/css2?family=Kotta+One&family=Yaldevi:wght@300;500;700&display=swap](https://fonts.googleapis.com/css2?family=Kotta+One&family=Yaldevi:wght@300;500;700&display=swap)');
...
with menu[0]:
    ...
    <b>බුද්ධික සම්පත්මචං, නියමයි! ඔන්න අපි කලින් Generate කරගත්ත, Copyright ප්‍රශ්න නැති, ලස්සන AI Images 5 ම (Background එකත් ඇතුළුව) ඔයා දුන්න Code එකට මම සෙට් කළා.
...
with menu[1]:
    # Registration Image එක මෙතනට සෙට් කළා
